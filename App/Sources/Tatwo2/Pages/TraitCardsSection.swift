// 照搬自 Apps/TatwoUltraworkMac/Sources/TatwoUltraworkMac/TraitCardsSection.swift；改動 2 行（原因：run A modes 照搬；移除舊 core import，資料由同名 Facade 提供）
import SwiftUI
...
func traitModelColor(_ modelID: String) -> Color {
    ...
    if key.contains("gpt-6") { return .green }
    if key.contains("gpt-5.6") { return .mint }
