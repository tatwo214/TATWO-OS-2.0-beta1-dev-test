...
RUN = os.path.join(REPO, ".tatwo-ultrawork", "協作考試", "20260703-collab-r1")
...
LINEUPS = {
    "lineup-A": {"builder": "gpt-5.4", "reviewer": "sonnet-5", "sub": "minimax-m3"},
    "lineup-B": {"builder": "gpt-5.5", "reviewer": "gpt-5.4", "sub": "minimax-m3"},
}
